...
<template>
    ...
    >
        <div>
            <Link href="">
                <img
                    ...
                    "
                    class="w-full h-48 object-cover object-center bg-red-300"
                    alt=""
                />
            </Link>
            <div class="p-4">
                ...
                <p>
                    Listé le
                    {{ new Date(listing.created_at).toLocaleDateString() }} par
        ...
        <div v-if="listing.tags" class="flex items-center gap-3 px-4 pb-4 overflow-x-scroll">
